...
class Reservation extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            hikeIn: false,
            date: '',
            showModal: false //shows model when set to true
        };
    }
    ...
    toggleModal() {
        this.setState({ showModal: !this.state.showModal }); //sets showModal to the opposite value
    }
    ...
    render() {
        return (
            <ScrollView>
                ...
                <Modal //this modal displays the reservation from input
